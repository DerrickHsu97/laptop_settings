...
vim.keymap.set("i", '<c-=>', 'coc#pum#visible() ? coc#pum#next(1) : v:lua.check_back_space() ? "<c-=>" : coc#refresh()', opts)
vim.keymap.set("i", '<c-_>', [[coc#pum#visible() ? coc#pum#prev(1) : "/<c-_>"]], opts)
...
vim.keymap.set("v", "<leader>fs", "<Plug>(coc-format-selected)")
