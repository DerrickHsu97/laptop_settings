...
vim.api.nvim_set_hl(0, "CocHighlightRead", {bg = "#F9E07B" , fg = "#000000"})
vim.api.nvim_set_hl(0, "CocHighlightWrite", {bg = "#F9E07B" , fg = "#000000"})
vim.api.nvim_set_hl(0, "CocHighlightText", {bg = "#BEBEBE" , fg = "#000000"})
